...
if (isset($_POST['btnn'])){
    extract($_POST);
    echo $q="insert into payments values(null,'$bid','$amt',curdate())";
    insert($q);
    $q="update booking set status='Payment Completed' where booking_id='$bid'";
    update($q);
...
<div class="container">
  <div class="row justify-content-center">
   ...
   <table class="table text-white">
    <tr>
        <th>Amount </th>
        <td><input type="text" class="form-control" required value=" <?php echo $amt ?>" name="amount" id=""></td>
    </tr>
    <tr>
        <th>Ac/No </th>
    ...
    <tr>
        <th>Expiry date </th>
        <td><input type="date" class="form-control" required name="" id=""></td>
    </tr>
    <tr>
        <th>CVV* </th>
        <td><input type="text" class="form-control" required name="" id=""></td>
