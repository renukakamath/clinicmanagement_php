...
if(isset($_POST['sub'])){
	extract($_POST);
	$q="INSERT INTO `login` VALUES(null,'$uname','$pss','pending')";
	$ids=insert($q);
	$qry="INSERT INTO `doctor` VALUES(null,'$ids','$fname','$lname','$phone','$email','$place','$qul','$gender', '$dob')";
	insert($qry);
}
?> 
...
<section id="hero">
    ...
    <h2 style="font-size: 30px;" class="text-white" id="hstyle">Doctor Registraion</h2>
<table class="table " style="color:black;">
    ...
    <tr>
     ...
     <tr>
        <th>qualificatione</th>
        <td><input type="text" required class="form-control" required class="form-control" name="qul" id=""></td>
    </tr>
     <tr>
        <th>Gender </th>
